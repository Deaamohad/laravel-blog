                        ...
                        <div class="card-body">
                            <div class="flex items-start justify-between">
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="post-content text-gray-600 line-clamp-3 break-words overflow-wrap-anywhere word-break-break-word pr-16 relative">
                                        {{ Str::limit($post->content, 150) }}
                                        <span class="absolute right-0 bottom-0 flex items-center text-gray-700 text-sm font-medium">
